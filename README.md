...
Esta ecuación se utilizó únicamente para el rango $$15 \le M_{\rm ini} \le 40$$, considerando la ecuación de $$M_{\rm BH, core}$$ respectiva. Para el rango $$45 \le M_{\rm ini} \le 120$$ se asumió igual a 0.
